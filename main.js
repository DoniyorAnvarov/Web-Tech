...
let headerHedaer = document.querySelector('.nav_header');
let headerList = document.querySelector('.nav__list');
let hedaerLogo = document.querySelector('.nav__logo');/* nav__logo */

headerNavLine.addEventListener('click', function (e) {
   this.classList.toggle('active');
   headerHedaer.classList.toggle('active');
   headerList.classList.toggle('active');
   hedaerLogo.classList.toggle('active');
...
let views = document.querySelector('.view')
    ...
    let cardBlock = document.querySelectorAll('.header_img'),
